...
const Sandbox = () => (
  <>
    ...
    <Icon size={2} disabled onClick={() => { console.log('!!!'); }} size={IconSizes.small}name={IconNames.Atom} />
     <Icon size={2} onClick={() => { console.log('!!!'); }} size={IconSizes.large}name={IconNames.Edit} />
