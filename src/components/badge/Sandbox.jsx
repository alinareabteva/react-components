...
const Sandbox = () => {
  ...
  return (
    ...
    <Button className="badge-wrapper">
      <Icon  name={IconNames.Letter} size={state.iconSize}/>
      <Badge value="new" />
    </Button>
    <Button>
      <Icon name={IconNames.Letter} size={state.iconSize} />
    ...
    <Button className="badge-wrapper">
      <Icon name={IconNames.Message} size={state.iconSize} />
      <Badge value={2} />
    </Button>
    <Button>
      <Icon name={IconNames.Message} size={state.iconSize}  />
    ...
    <div className="position">
      <Icon name={IconNames.Phone} size={state.iconSize}  />
    ...
    <Button className="badge-wrapper">
      <Icon name={IconNames.Notification} size={state.iconSize} />
      <Badge outer value={11} />
    </Button>
    <Button>
      <Icon name={IconNames.Wifi} size={state.iconSize} />
    ...
    <section>
    <Button className="badge-wrapper">
      <Icon name={IconNames.Warning} size={state.iconSize} />
      <Badge circle warning value={3} />
    </Button>
    <Button className="badge-wrapper">
      <Icon name={IconNames.Alert} size={state.iconSize} />
      <Badge circle alert value={5} />
    </Button>
    <Button className="badge-wrapper">
      <Icon name={IconNames.Success} size={state.iconSize} />
      <Badge circle success value={17} />
    </Button>
    <Button>
      <Icon name={IconNames.Info} size={state.iconSize} />
